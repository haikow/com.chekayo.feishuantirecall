...
public class AntiRecall implements IXposedHookLoadPackage, IXposedHookZygoteInit {
    ...
    // 适配飞书二次开发/私有化版(部分车企等白标: 应用包名换, 但内核类保留 com.bytedance.lark.*):
    ...
    static final String MODULE_VERSION = "1.6.6";
    static final int MODULE_VERSION_CODE = 14;   // 与 AndroidManifest versionCode 同步; 更新检查比对用
